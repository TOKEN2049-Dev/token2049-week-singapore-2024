		...
		<Box sx={{ flexGrow: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
			<Box sx={{ top: 0, backgroundColor: "inherit", zIndex: 1, paddingBottom: "2px", padding: "1px 10px", flexShrink: 0 }}>
				<Typography sx={{ fontSize: "16px", fontWeight: 600, textAlign: "center" }} gutterBottom>
					Explore <Box sx={{ display: "inline", fontWeight: 600, color: "#2771FC" }}>events</Box> here
				</Typography>
			</Box>
		</Box>
	</Box>
...
const MobileSidebar = forwardRef(function MobileSidebar({ events, isLoading, onEventClick }, ref) {
